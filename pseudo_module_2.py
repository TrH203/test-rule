...
class Trigger_Kafka_Message(Init_Module):
    ...
    def process(self, input: InputFrame) -> List[TrackedObject]:
        pass
    ...
    model_result=[
        {
            ...
            "action": None,
            "color": None,
            "ppe_status": {"helmet": True, "vest": False, "safety_shoes": True},
        },
        {
            "tracked_id": 2,
            "bbox": [10, 20, 40, 20],
...
"""
Phát hiện khách hàng giơ tay gọi nhân viên pha chế nhưng không có nhân viên pha chế nào đến phục vụ trong vòng 5 phút.
"""
...
"""
Kiểm tra kho hàng sau mỗi 30 phút để đảm bảo rằng nhân viên quản lý đã kiểm tra tất cả các khu vực kho hàng.
"""
# Workflow 1
